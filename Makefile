...
build-image:
	...
	@docker images n8n-${N8N_VERSION} -q > /dev/null 2>&1 && echo "Image 'n8n-${N8N_VERSION}' already exists. Removing..." && docker rmi -f n8n-${N8N_VERSION} || echo "No existing image to remove."
	docker build \
